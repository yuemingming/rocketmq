...
public class LocalFileOffsetStore implements OffsetStore {
    ...
    /**
     * 消息进度存储目录，可以通过 -Dorocketmq.client.localOffsetStoreDir,如果未指定，则默认为用户主目录 /.rocketmq_offsets
     */
    ...
    /**
     * 消息进度存储文件，LOCAL_OFFSET_STORE_DIR/.rodcketmq_offsets/{mQClienFactory.getClientID()}/groupName/offsets.json
     */
