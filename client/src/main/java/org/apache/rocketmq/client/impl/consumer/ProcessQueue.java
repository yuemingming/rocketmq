...
public class ProcessQueue {
    ...
    /**
     * 判断锁是否过期，锁超时时间默认为 30 s，可以通过系统参数 rocketmq.client。rebalance.lockMaxLiveTime 设置
     *
     * @return
     */
    ...
    /**
     * 判断 pullMessageService 是否空闲，默认 120s，通过系统参数 rocketmq.client.pull.pullMaxIdleTime 来设置
     *
     * @return
     */
    ...
    /**
     * 移除消费超时的消息，默认超过十五分钟未消费的消息将延迟 3 个延迟级别再消费。
     *
     * @param pushConsumer
     */
    public void cleanExpiredMsg(DefaultMQPushConsumer pushConsumer) {
        ...
        for (int i = 0; i < loop; i++) {
            ...
            try {
                ...
                try {
                    if (!msgTreeMap.isEmpty() && System.currentTimeMillis() - Long.parseLong(
    ...
    /**
     * 获取当前消息最大间隔。getMaxSpan()/20并不能说明 procequeue 中包含的消息个数，但是能说明当前处理队列中第一条消息和最后一条消息的偏移量已经超过的消息个数。
     *
     * @return
     */
    ...
    /**
     * 从 ProcessQueue 中取出 batchSize 调消息
     * @param batchSize
     * @return
     */
