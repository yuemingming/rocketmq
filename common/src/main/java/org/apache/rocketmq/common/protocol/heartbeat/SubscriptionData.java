...
public class SubscriptionData implements Comparable<SubscriptionData> {
    public final static String SUB_ALL = "*";//过滤模式，是否全匹配
    ...
    private Set<String> tagsSet = new HashSet<String>();//消息过滤 tag 集合，消费端过滤式进行消息过滤的依据。
    private Set<Integer> codeSet = new HashSet<Integer>();//消息过滤 tag hashcode 集合
