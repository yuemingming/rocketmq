...
public class NamesrvConfig {
    ...
    private String rocketmqHome = System.getProperty(MixAll.ROCKETMQ_HOME_PROPERTY, System.getenv(MixAll.ROCKETMQ_HOME_ENV));//rocket mq 主目录。
    private String kvConfigPath = System.getProperty("user.home") + File.separator + "namesrv" + File.separator + "kvConfig.json";//NameServer 存储 KV 配置属性的持久化路径
    private String configStorePath = System.getProperty("user.home") + File.separator + "namesrv" + File.separator + "namesrv.properties";//nameServer 默认配置文件路径，不生效。需要启动时通过-c 选项配置。
